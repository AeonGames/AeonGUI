...
namespace AeonGUI
{
        ...
        horizontalscroll ( ScrollBar::HORIZONTAL )
    {
        ...
        close.SetNormalImage ( new Image ( close_name, close_width, close_height, AeonGUI::Image::RGBA, AeonGUI::Image::BYTE, close_data ) );
        close.SetPressedImage ( new Image ( close_down_name, close_down_width, close_down_height, AeonGUI::Image::RGBA, AeonGUI::Image::BYTE, close_down_data ) );
        close.SetDimensions ( close_width, close_height );
        close.SetMouseListener ( this );

        maximize.SetParent ( this );
        maximize.SetNormalImage ( new Image ( maximize_name, maximize_width, maximize_height, AeonGUI::Image::RGBA, AeonGUI::Image::BYTE, maximize_data ) );
        maximize.SetPressedImage ( new Image ( maximize_down_name, maximize_down_width, maximize_down_height, AeonGUI::Image::RGBA, AeonGUI::Image::BYTE, maximize_down_data ) );
        maximize.SetDimensions ( maximize_width, maximize_height );
        maximize.SetMouseListener ( this );

        minimize.SetParent ( this );
        minimize.SetNormalImage ( new Image ( minimize_name, minimize_width, minimize_height, AeonGUI::Image::RGBA, AeonGUI::Image::BYTE, minimize_data ) );
        minimize.SetPressedImage ( new Image ( minimize_down_name, minimize_down_width, minimize_down_height, AeonGUI::Image::RGBA, AeonGUI::Image::BYTE, minimize_down_data ) );
