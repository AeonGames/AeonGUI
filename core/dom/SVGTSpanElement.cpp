...
namespace AeonGUI
{
    namespace DOM
    {
        // Font CSS helpers are defined in SVGTextElement.cpp; redeclare locally
        // to avoid a public header dependency.  Ideally these would live in a
        // shared internal header; keeping duplication minimal for now.
