...
namespace AeonGUI
{
    ...
    GLDECLAREFUNCTION ( PFNGLISPROGRAMPROC, glIsProgram );
    GLDECLAREFUNCTION ( PFNGLISBUFFERPROC, glIsBuffer );
    GLDECLAREFUNCTION ( PFNGLISVERTEXARRAYPROC, glIsVertexArray );
