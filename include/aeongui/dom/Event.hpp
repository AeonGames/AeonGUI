...
namespace AeonGUI
{
    namespace DOM
    {
        ...
        public:
             ...
             */
            AEONGUI_DLL Event ( const DOMString& type, const std::optional<EventInit>& eventInitDict = {} );
             ...
             *  @return Pointer to the original target. */
             ...
             *  @return The phase constant (NONE, CAPTURING_PHASE, AT_TARGET, or BUBBLING_PHASE). */
            constexpr uint16_t eventPhase() const
            {
                return m_eventPhase;
            }
            /** @brief Check whether the event bubbles.
             *  @return true if bubbles. */
        ...
        protected:
             ...
             */
            AEONGUI_DLL void setTrusted ( bool trusted );
        private:
