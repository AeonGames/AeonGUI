...
function(aeongui_configure_duktape)
    ...
    if(DUKTAPE_LIBRARY)
        ...
        if(PYTHON_EXECUTABLE)
            ...
            execute_process ( COMMAND ${PYTHON_EXECUTABLE} ${CMAKE_BINARY_DIR}/find_pyyaml.py OUTPUT_VARIABLE PYYAML OUTPUT_STRIP_TRAILING_WHITESPACE)
            if(NOT PYYAML)
                message(STATUS "PYYAML module not found, attempting install")
                execute_process ( COMMAND ${PYTHON_EXECUTABLE} -m pip install pyyaml RESULT_VARIABLE PIP_INSTALL_RESULT)
                if(NOT PIP_INSTALL_RESULT EQUAL 0)
                    message(FATAL_ERROR "PYYAML instalation failed. Try manual instalation Interpreter found was: ${PYTHON_EXECUTABLE}")
                endif()
            endif()
        else()
